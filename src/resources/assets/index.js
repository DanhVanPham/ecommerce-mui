...
export { default as SentRequestIcon } from './SentRequestIcon';
export { default as PasswordIcon } from './PasswordIcon';

export { default as BoringIcon } from './icon-boring.svg'
export { default as ConstructionIcon } from './icon-construction.svg'
