    ...
    return (
        <Stack>
            <Stack py={3} direction='row' justifyContent='space-between' alignItems='center'>
                ...
                <Typography fontSize='20px' fontWeight={500} color='#EB2606' lineHeight='30px'>{fCurrencyVND(1078000)}</Typography>
            </Stack>
            <Divider />
            <Stack pt={3} pb={2} spacing={2}>
                ...
                >
                    ...
                    <Typography color='#060709' lineHeight='30px'>{fCurrencyVND(1078000)}</Typography>
                </Stack>
                <Stack direction='row'
                    justifyContent='space-between'
                    alignItems='center'
                ...
                >
                    ...
                    <Typography color='#060709' lineHeight='30px'>{fCurrencyVND(35000)}</Typography>
                </Stack>
            </Stack>
            <Divider />
